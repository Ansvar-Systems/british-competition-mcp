/**
 * SQLite database access layer for the CMA (Competition and Markets Authority) MCP server.
 *
 * Schema:
 *   - decisions    — CMA enforcement decisions (abuse of dominance, cartels, sector inquiries)
